...
//Enrollment List
    Route::get('admin/enrollment','EnrollController@index');
    Route::post('/insert/enrollment','EnrollController@store');
    Route::get('/get_all_enrollment','EnrollController@get_all_enrollment');
